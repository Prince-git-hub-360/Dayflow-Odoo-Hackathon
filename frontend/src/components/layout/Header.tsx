...
export const Header: React.FC = () => {
  ...
  return (
    <header className="h-16 glass-card border-b border-slate-800/80 px-6 flex items-center justify-between sticky top-0 z-30 bg-slate-950/80 backdrop-blur-md">
      <div className="flex items-center gap-4">
        <div className="flex items-center gap-2 text-xs font-mono text-indigo-400 bg-indigo-500/10 border border-indigo-500/20 px-3 py-1.5 rounded-lg shadow-inner">
      ...
      <div className="flex items-center gap-4">
        <div className="relative">
          <button
            ...
            className="relative p-2 text-slate-300 hover:text-white hover:bg-slate-800/70 rounded-xl transition-all"
          >
          ...
          {showDropdown && (
            <div className="absolute right-0 mt-2 w-80 glass-card rounded-2xl p-4 shadow-2xl border border-slate-800 z-50 animate-scale-up">
