        ...
        <div className="glass-card rounded-2xl p-8 shadow-2xl border border-slate-800">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  type="text"
                  {...register('first_name')}
                  className="w-full bg-slate-900/80 border border-slate-800 rounded-xl px-4 py-2 text-sm text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/50"
                  placeholder="John"
                />
                {errors.first_name && (
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-slate-900/80 border border-slate-800 rounded-xl px-4 py-2 text-sm text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 pl-10"
                  placeholder="EMP999"
                />
                <BadgeCheck className="w-4 h-4 text-slate-500 absolute left-3.5 top-2.5" />
              </div>
              {errors.employee_id && (
                <p className="mt-1 text-xs text-rose-400">{errors.employee_id.message}</p>
              )}
            </div>
            ...
            <div>
              ...
              />
              {errors.job_title && (
                <p className="mt-1 text-xs text-rose-400">{errors.job_title.message}</p>
              )}
            </div>
